            ...
            for t in range(max_timesteps):
                ...
                if config['policy_class'] == "ACT":
                    if t % query_frequency == 0:
                        ...
                        print(f"CURRENT TYPE IS {type}")
                        all_actions = policy(qpos, curr_image, type=type)
                    if temporal_agg:
...
def train_bc(train_dataloader, val_dataloader, config):
    ...
    policy_config = config['policy_config']
    resume_ckpt = None
    # resume_ckpt = "/Users/is/VSCode/bachelors_diploma/v10_ALOHA_change_transformer/ckpt_dir/policy_epoch_300_seed_0.ckpt"
